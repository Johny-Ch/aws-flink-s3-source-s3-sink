...
public class S3InputS3Output {
    ...
    public static void main(String[] args) throws Exception {
        ...
        dataSource.writeAsText("s3://ast-poc-bucket/kda/output/", FileSystem.WriteMode.OVERWRITE);

        executionEnvironment.execute("S3InputS3Output-OVERWRITE");
    }
}
