...
public class S3InputS3OutputFilter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        dataSource.map(player -> {return new OutPlayer(player);})
                .writeAsCsv("s3://ast-poc-bucket/kda/output/", FileSystem.WriteMode.OVERWRITE);

        executionEnvironment.execute("S3InputS3OutputFilter");
    }
}
