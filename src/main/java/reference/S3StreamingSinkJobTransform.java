...
public class S3StreamingSinkJobTransform {
    ...
    private static DataStream<InPlayer> createSourceFromStaticConfig(StreamExecutionEnvironment env) {
        ...
        return env.addSource(new FlinkKinesisConsumer<>(inputStreamName,
                (DeserializationSchema) new InPlayer(),
                inputProperties));
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<InPlayer> input = createSourceFromStaticConfig(env);
